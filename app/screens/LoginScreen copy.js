      ...
      >
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0)' }}>
          <View style={{ marginBottom: 5 }}>
            <Text style={{ fontSize: 25, fontWeight: 'bold', marginVertical: 10, color: COLORS.white, textAlign: 'center' }}>
              Welcome to DonateABook !
            </Text>
          </View>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'center', marginBottom: 20 }}>
            <TouchableOpacity onPress={() => console.log('Pressed')} 
             style={{ alignItems: 'center', backgroundColor: COLORS.white, justifyContent: 'center', flexDirection: 'row', 
                     height: 48, borderWidth: 1, borderColor: COLORS.white, marginRight: 8, 
                     borderRadius: 8, paddingHorizontal: 16 }}>

              <Image source={require('../components/assets/facebook.png')} style={{ height: 24, width: 24, marginRight: 8 }} resizeMode="contain" />
              <Text style={{ color: COLORS.black, fontSize: 16 }}>Facebook</Text>
              
            </TouchableOpacity>
            <TouchableOpacity onPress={() => console.log('Pressed')} 
              style={{ alignItems: 'center', backgroundColor: COLORS.white, justifyContent: 'center', flexDirection: 'row', 
                height: 48, borderWidth: 1, borderColor: COLORS.grey, marginLeft: 8, 
                borderRadius: 8, paddingHorizontal: 16 }}>
              <Image source={require('../components/assets/google.png')} style={{ height: 24, width: 24, marginRight: 8 }} resizeMode="contain" />
              <Text style={{ color: COLORS.black, fontSize: 16 }}>Google    </Text>
            </TouchableOpacity>
          </View>
